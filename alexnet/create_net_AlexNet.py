...
def build_AlexNet(split, num_classes, batch_size, resize_w, resize_h, crop_w=0, crop_h=0, crop_margin=0, mirror=0, rotate=0, HSV_prob=0, HSV_jitter=0, train=True):
    ...
    n.data, n.label, n.label_score = L.Python(module='layers', layer='customDataLayerWithLabelScore',
    ...
    fc8 = L.InnerProduct(fc8input, num_output=num_classes, weight_filler=dict(type='gaussian', std=0.005),
    ...
    n.loss = L.Python(fc8, n.label, n.label_score, module='layers', layer='SoftmaxSoftLabel', ntop=1)
