...
weights = '../../../datasets/WebVision/models/saved/WebVision_Inception_LDAscored_500_80000chunck_iter_300000.caffemodel' # snapshot to restore (only weights initialzation)
#snapshot = 0
gpus = [0,1,2,3] # list of device ids # last GPU requires por mem (9000-5000)
timing = False # show timing info for compute and communications
plotting = True # plot loss
test_interval = 2000 # do validation each this iterations #5000
